...
const HomePage = () => {
  return (
     ...
     <div className="page-style">
      ...
      <img src="\images\vckbanner.png" width="100%" height="300px"></img>
    ...
    <img alt="library" src="images\library.jpg" height="186%" width="50%"></img><img alt="vckhead" src="images\vckhead.jpg" height="200px" width="50%"></img>
